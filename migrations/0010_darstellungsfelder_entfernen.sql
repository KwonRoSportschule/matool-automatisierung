...
--
-- Seit dem 25.09.2026 liegen Nutzlasten AES-GCM-verschluesselt vor
-- ("enc:v1:..."). JSON-Funktionen brechen auf solchem Text mit "malformed
-- JSON" ab; der CASE prueft deshalb zuerst json_valid und laesst
-- verschluesselte Zeilen aus. Diese bereinigt der Store beim naechsten Lauf
-- selbst: Er entschluesselt jeden abweichenden Stand, entfernt die
-- Darstellungsfelder und uebernimmt den Hash still, wenn sich fachlich
-- nichts geaendert hat (buildRebaselineStatements in matool-store.ts).
